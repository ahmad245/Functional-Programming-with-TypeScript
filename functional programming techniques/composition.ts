...
// EN
// The type of the only argument of f must match the return type of the g function. 
//These limitations can be expressed in a more correct definition of the compose function:
